...
import mercury from '../assets/mercuriy.png'
import mercuryStructure from '../assets/mercuriy-structure.png'
import mercuryGeo from '../assets/mercuriy-geo.png'
